...
db.User.hasMany(db.Picture, { foreignKey: 'user_id', sourceKey: 'id' }); // foreignKey는 여기서 설정하면 생성. 미리 생성하면 이미 있는 키라서 set 불가
